...
class EolDeviceNotification {
    ...
    static void maybeShow(Context ctx) {
        ...
        switch (Build.DEVICE) {
            case "flame":
            case "coral":
                eolDate = "November 2022";
                break;
            case "sunfish":
                eolDate = "September 2023";
                break;
            default:
                return;
        }
        ...
        String text = "This device has stopped receiving full security updates since " + eolDate
                + ". It's recommended to replace it as soon as possible. Tap to see more info.";
